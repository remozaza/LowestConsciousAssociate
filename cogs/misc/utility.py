...
class OtherMisc(commands.Cog):
    ...
    #ping command
    @app_commands.command(name = "ping", description = "Checks Egorikusa bot's response time.")
    ...
    async def invite(self, interaction: discord.Interaction):
        ...
        view.add_item(discord.ui.Button(label = "Support Server", style = discord.ButtonStyle.link,
                                        url = "https://discord.com/invite/mailstealer"))
        emb = discord.Embed(title = "Bot's invite link",
                            description = "[Invite Link](https://discord.com/oauth2/authorize?client_id=1221223534194593892&permissions=8&scope=bot)",
                            colour = 0x2F3136)
        emb.add_field(name="Support Server", value="[Support Server](https://discord.com/invite/mailstealer)")
